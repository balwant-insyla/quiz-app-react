...
import  { 
  ...
  TablePagination, TableRow, TableSortLabel, Toolbar, Typography, Paper, IconButton
...
const headCells = [
  { id: 'name', numeric: false, disablePadding: true, label: 'Subject' },
...
export default function EnhancedTable({ editSubjectCallback }) {
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>
                      <IconButton aria-label="edit" onClick={()=> editSubjectCallback(row)}>
                        <EditIcon />
                        </IconButton>
                      </TableCell>
                      <TableCell>
                      <IconButton aria-label="delete" onClick={(e) => dispatch(deleteSubject(row._id))}>
                        <DeleteIcon />
                        </IconButton>
                      </TableCell>
                    </TableRow>
